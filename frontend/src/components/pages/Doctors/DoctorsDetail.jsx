...
//               </div>
//               <p className="text_para text-[14px] md:text-[15px] leading-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eveniet tempore sunt adipisci et non. Nemo delectus optio voluptas</p>
